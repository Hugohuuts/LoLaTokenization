...
def load_custom_class(
    model_name_or_repo_link: str, device: torch.device = None, **model_args
) -> tuple[AutoTokenizer, CustomModelAbstract]:
    """
    ...
    if "roberta" in model_name_or_repo_link.lower():
        ...
        "bert" in model_name_or_repo_link.lower()
        and "roberta" not in model_name_or_repo_link.lower()
    ):
